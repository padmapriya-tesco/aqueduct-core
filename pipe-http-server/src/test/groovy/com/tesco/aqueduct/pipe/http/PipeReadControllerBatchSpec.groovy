...
class PipeReadControllerBatchSpec extends Specification {
    ...
    void "A batch of messages that equals the payload size is still transported"() {
        given:
        def messages = [
                Message(type, "a", "contentType", 100, null, null, DATA_BLOB),
                Message(type, "b", "contentType", 101, null, null, DATA_BLOB),
                Message(type, "c", "contentType", 102, null, null, DATA_BLOB)
        ]
